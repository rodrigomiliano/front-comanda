...
import { withStyles, makeStyles, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from "@material-ui/core";
    ...
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="customized table">
        ...
        <TableBody>
          {ordenes &&
            ordenes.map(
              ({ id, mesa, usuario, ingreso, ultimoPedido, estado }) => (
